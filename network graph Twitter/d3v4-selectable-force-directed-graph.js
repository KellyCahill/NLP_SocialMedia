function createV4SelectableForceDirectedGraph(svg, graph) {
    ...
    function zoomed() {
        ...
        d3.selectAll("line")
            .attr("stroke-width", function(d) { return 5*d.value/d3.event.transform.k; });

        d3.selectAll(".labels")
            .style("font-size", 12/d3.event.transform.k)
            .attr('x', 6/d3.event.transform.k)
            .attr('y', 3/d3.event.transform.k);
    ...
    var texts = ['Use the scroll wheel to zoom',
                 'Text will appear when you zoom close enough',]

    svg.append('text')
        .attr('x', 10)
        .attr('y', 20)
        .text("Zoom in to see text appear");
